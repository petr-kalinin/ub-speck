...
\author{
\hbox to 11cm{\hfill\rm \small Петр Калинин, 2016--\dots}\\[-0.15cm]
\hbox to 11cm{\hfill\rm \small Эту презентацию можно распространять по лицензии}\\[-0.15cm]
\hbox to 11cm{\hfill\rm \small GNU General Public License версии 3.0 или старше}\\[-0.15cm]
...
\begin{document}
%-----------------------------------------
\begin{slide}[bm=]{<<На подумать>> перед началом лекции}
\begin{itemize}
\item Какие компиляторы C++ вы знаете?
\item Что такое C++11, C++14, C++17, C++20, что было до и что будет после?
...
\item Существуют разные версии стандарта: C++03, C++11 (C++0x), C++14, C++17, C++20
...
\item Диагностировать ошибку компиляции, <<вылететь>>, выдать некорректные данные, отформатировать жесткий диск\dots
